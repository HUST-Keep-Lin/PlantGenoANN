import torch
import warnings
from .caduceusph.configuration_caduceus_ph import CaduceusPhConfig
from .caduceusph.modeling_segment_caduceus import SegmentCaduceus
...
class CaduceusModelWrapper:
    ...
    def _load_model(self):
        ...
        try:
            self.model = SegmentCaduceus.from_pretrained(self.model_path)
